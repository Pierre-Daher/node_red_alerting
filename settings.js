 ...
 ******************************************************************************/
	...
	adminAuth: {
		...
		users: [
			...
			{
				username: "Daher",
				password: "$2b$08$UeVl9wtReAnnW/QZHVZ67OhNUI0Hv2OgQ87hYKuks4nQfBNS2jUcy",
				permissions: "read"
			},
			{
				username: "f.fremyet",
    ...
    https: {
      key: require("fs").readFileSync('./nodecerts/node-key.pem'),
      cert: require("fs").readFileSync('./nodecerts/node-cert.pem')
    },
